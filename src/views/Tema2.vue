      ...
      .row.justify-content-center.z-2.mb-3
        .col-lg-10.p-4.drop-shadow(data-aos="fade-down")
          div.banner-text.shadow
            p.mb-0 Procesar los cargos y pagos de los huéspedes se conoce en la jerga hotelera como posteo, esta es una expresión españolizada de la palabra inglesa “<em>post</em>” hoy tan de moda por las redes sociales. Postear es la acción de agregar o restar los cargos de los huéspedes en la cuenta. Para entender apropiadamente cómo funciona la cuenta de un cliente, hay que entender su naturaleza contable.

    .p-4.py-3.rounded-4.bg-secundario-s5.mb-5
      p.mb-0 En este sentido los activos son elementos que tienen valor monetario. Los pasivos son cargos financieros u otras obligaciones contractuales o deudas. Estos dos conceptos proporcionan los fundamentos a un sistema de contabilidad y soporte a las cuentas huésped.
